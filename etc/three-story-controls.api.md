## API Report File for "@kagawa0710/three-story-controls"
...
// Warning: (ae-forgotten-export) The symbol "BaseAdaptorEventMap" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
...
// Warning: (ae-forgotten-export) The symbol "CameraRigEventMap" needs to be exported by the entry point index.d.ts
//
// @public
...
// Warning: (ae-forgotten-export) The symbol "POIsControlsEventMap" needs to be exported by the entry point index.d.ts
//
// @public
